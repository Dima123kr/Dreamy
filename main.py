...
def diary():
    ...
    if form.validate_on_submit():
        ...
        message = f'''
                    ...
                    Начало сна-{";".join(list(map(str, diary_[2])))}.
                    Окончание сна-{";".join(list(map(str, diary_[4])))}.
                    Оценка состояния перед сном от 1 до 10-{";".join(list(map(str, diary_[8])))}.
                    Оценка состояния после сна от 1 до 10-{";".join(list(map(str, diary_[10])))}.
                    ...
                    этот месяц."):
                    Начало сна-{";".join(list(map(str, diary_[3])))}.
                    Окончание сна-{";".join(list(map(str, diary_[5])))}.
                    Оценка состояния перед сном от 1 до 10-{";".join(list(map(str, diary_[9])))}.
                    Оценка состояния после сна от 1 до 10-{";".join(list(map(str, diary_[11])))}.
                    Также важно учесть что, если все данные за определенный период равны нулю, 
                    то данный период учитывать не надо.
                    Также, желательно не использовать нумерацию.
